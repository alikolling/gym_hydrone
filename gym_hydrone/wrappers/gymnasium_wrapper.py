"""Wraps an Farama Gymnasium environment to be used as a dm_env environment."""
...
from gym_hydrone import specs
from gym_hydrone import types
...
def _convert_to_spec(space: gym.Space, name: Optional[str] = None) -> types.NestedSpec:
    ...
    if isinstance(space, spaces.Discrete):
        return specs.DiscreteArray(num_values=space.n, dtype=space.dtype, name=name)  # type: ignore
